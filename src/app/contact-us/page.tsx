        ...
        <main className="min-h-screen bg-black text-white selection:bg-accent selection:text-black pt-32 pb-20">
            ...
            <div className="max-w-[1200px] mx-auto min-h-[70vh] flex flex-col items-center justify-center text-center px-6">
                ...
                <motion.div
                    ...
                    className="text-lg md:text-2xl text-white/50 max-w-3xl leading-relaxed mt-10"
                >
                    <a href="mailto:hello@compliledger.com" className="text-blue-500 hover:text-white transition-colors border-b border-blue-500/50 pb-1 mr-4">
