        ...
        <main className="min-h-screen bg-black text-white selection:bg-accent selection:text-black pt-32 pb-20">
            ...
            <div className="max-w-[1200px] mx-auto min-h-[70vh] flex flex-col items-center justify-center text-center px-6">
                <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white-500/10 text-white/80 border border-white/20 text-sm font-medium mb-8"
                >
                ...
                >
                    We protect <br /> the digital ledger.
                </motion.h1>
                ...
                >
                    Originating from the need for absolute data privacy during audit cycles, CompliLedger was built by cybersecurity veterans and cryptography experts to restore trust to the compliance process.
                </motion.p>
            </div>
