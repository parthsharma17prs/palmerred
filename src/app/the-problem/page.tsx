    ...
    return (
        <main className="min-h-screen bg-black text-white selection:bg-accent selection:text-black pt-32 pb-20">
            ...
            <div className="max-w-[1200px] mx-auto min-h-[70vh] flex flex-col items-center justify-center text-center px-6">
                ...
                >
                    Compliance is broken.<br />It exposes your data.
                </motion.h1>
                ...
                >
                    Centralized compliance is slow, insecure, and heavily reliant on manual processes. Sensitive data exposure during conventional audits poses massive risks to organizations worldwide.
                </motion.p>
            </div>
